...
export type JSONSchemaType<T> = StrictNullChecksWrapper<"JSONSchemaType",
...
export type PropertiesSchema<T> = StrictNullChecksWrapper<"PropertiesSchema",
    UncheckedPropertiesSchema<T>>
...
export type RequiredMembers<T> = StrictNullChecksWrapper<"RequiredMembers",
