    ...
    describe('exec', function () {
        ...
        describe('update', function () {
            ...
            describe('updateMany', function () {
                it('works', function (done) {
                    mquery(col).updateMany({name: 'exec'}, {name: 'test'}).exec(function (error) {
            ...
            describe('updateOne', function () {
                it('works', function (done) {
                    mquery(col).updateOne({name: 'exec'}, {name: 'test'}).exec(function (error) {
                        assert.ifError(error);
                        mquery(col).count({name: 'test'}).exec(function (error, res) {
                            assert.ifError(error);
                            assert.equal(res, 1);
            ...
            describe('replaceOne', function () {
                it('works', function (done) {
                    mquery(col).replaceOne({name: 'exec'}, {name: 'test'}).exec(function (error) {
                        assert.ifError(error);
        ...
        describe('deleteOne', function () {
            ...
            it('with justOne set', function (done) {
                var m = mquery(col).where({age: {$gte: 0}}).
                    ...
                    setOptions({justOne: false}).deleteOne();
                m.exec(function (err, res) {
                    assert.ifError(err);
                    assert.equal(res.result.n, 1);
                    done();
