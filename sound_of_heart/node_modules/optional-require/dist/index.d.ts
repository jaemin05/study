 ...
 */
export declare type OptionalRequireFunction = {
    /**
     * @param path - path to module to require
 ...
 */
export declare function makeOptionalRequire(callerRequire: NodeRequire, log?: (message: string, path: string) => void): OptionalRequireFunction;
 ...
 *
 */
export declare const optionalRequire: OptionalRequireFunction;
/**
 ...
 * calling context.
 */
export declare const optionalRequireCwd: OptionalRequireFunction;
